(function(root, factory) {
  ...
  const A = Object.freeze([
    ...
    ['=', ['iota', 'x'], 'qx'], ['=', ['B', 'x'], ['Cl', ['union', 'B', ['set', 'qx']]]], ['=', ['Adm', 'x', 'B'], ['and', ['=', ['norm', ['B', 'x']], 1], ['=', ['P', ['B', 'x']], 1]]], ['imp', ['Adm', 'x', 'B'], ['One', ['B', 'x']]],
    ['=', ['D', 'q', 'B'], ['N', ['U', 'q'], ['R', 'q', 'B'], ['T', 'q', 'B'], ['C', 'q', 'B'], ['Om', 'q', 'B'], ['Phi', 'q', 'B'], ['P', 'q', 'B'], ['G', 'q', 'B']]], ['=', ['Om', 'q', 'B'], ['not', ['S', ['R', 'q', 'B']]]], ['=', ['S', 'q', 'B'], ['and', ['C', 'q', 'B'], ['P', 'q', 'B'], ['not', ['Om', 'q', 'B']]]], ['=', ['Pres', ['Om', 'q', 'B'], 'B'], 1],
    ['=', ['EqB', 'a', 'b'], ['eq', ['D', 'a', 'B'], ['D', 'b', 'B']]], ['imp', ['EqB', 'a', 'b'], ['=', ['Cl', ['union', 'B', ['set', 'a', 'b']]], ['Cl', ['union', 'B', ['set', 'a']]]]], ['=', ['Red', 'B'], ['quot', 'B', 'EqB']], ['=', ['norm', ['Red', 'B']], 1],
    ['=', ['G', 'q', 'B'], ['and', ['Adm', 'q', 'B'], ['not', ['exists', 'r', ['and', ['in', 'r', 'B'], ['EqB', 'q', 'r']]]]]], ['imp', ['not', ['G', 'q', 'B']], ['=', ['B', 'q'], 'B']], ['=', ['Phi', 'q', 'B'], ['Focus', 'B', 'q']], ['=', ['E', 'B', 'phi'], ['PiE', ['Phi', 'phi', 'B']]],
    ['=', ['Valid', 'y', 'B'], ['and', ['sub', 'y', 'B'], ['=', ['norm', 'y'], 1], ['=', ['P', 'y'], 1]]], ['=', ['Valid', ['E', 'B', 'phi'], 'B'], 1], ['=', ['Active', 'B'], ['and', ['One', 'B'], ['forall', 'x', ['imp', ['Adm', 'x', 'B'], ['One', ['B', 'x']]]]]],
  ...
  const PROOFS = freezeDeep({ authority: 'src/one-logic-math-v1.js::CONTRACT.proofs', theorem: 'LivingPreservationUnderAdmittedDifference', conclusion: 'Admitted transition preserves Living(B)', order: ['One','ClosureIdempotence','AdmissionPreservesOne','UnknownPreservation','EquivalenceCollapse','ReductionNorm','NoGrowthNoChange','ExpressionValidity','Active','Living','LanguageClosure'], obligations: {
    ...
    AdmissionPreservesOne: { phase: 'transition', theorem: 'imp(Adm(x,B),One(B[x]))', requires: ['Adm(x,B)=and(norm(B[x])=1,P(B[x])=1)', 'B[x]=Cl(union(B,{qx}))'], checks: ['Admission','One'], result: 'One(B[x])' },
